...
export function Header({ activeTab, onTabChange }: HeaderProps) {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 flex h-14 items-center gap-4 border-b bg-gradient-to-l from-background to-blue-500/5 dark:from-background dark:to-primary/10 px-4 no-print sm:px-6">
